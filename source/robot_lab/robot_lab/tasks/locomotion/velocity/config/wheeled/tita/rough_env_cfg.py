...
class DDTTitaRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    # fmt: off
    joint_names = [
        "joint_left_leg_1", "joint_right_leg_1",     # hip
        "joint_left_leg_2", "joint_right_leg_2",     # thigh
        "joint_left_leg_3", "joint_right_leg_3",     # calf
        "joint_left_leg_4", "joint_right_leg_4",     # wheel
    ]
    # fmt: on
