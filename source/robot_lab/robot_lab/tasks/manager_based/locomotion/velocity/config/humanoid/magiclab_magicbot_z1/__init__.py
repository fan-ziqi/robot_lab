...
register_task(
    task_id="RobotLab-Velocity-Rough-MagicLab-Bot-Z1-v0",
    env_cfg=f"{__name__}.rough_env_cfg:MagicLabBotZ1RoughEnvCfg",
    agent_cfg_entries={
...
register_task(
    task_id="RobotLab-Velocity-Flat-MagicLab-Bot-Z1-v0",
    env_cfg=f"{__name__}.flat_env_cfg:MagicLabBotZ1FlatEnvCfg",
    agent_cfg_entries={
