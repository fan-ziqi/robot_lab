...
register_task(
    task_id="RobotLab-Velocity-Rough-FFTAI-GR1T1-v0",
    env_cfg=f"{__name__}.rough_env_cfg:FFTAIGR1T1RoughEnvCfg",
    agent_cfg_entries={
...
register_task(
    task_id="RobotLab-Velocity-Flat-FFTAI-GR1T1-v0",
    env_cfg=f"{__name__}.flat_env_cfg:FFTAIGR1T1FlatEnvCfg",
    agent_cfg_entries={
