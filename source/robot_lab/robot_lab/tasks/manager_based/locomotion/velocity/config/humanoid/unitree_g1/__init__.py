...
register_task(
    task_id="RobotLab-Velocity-Rough-Unitree-G1-v0",
    env_cfg=f"{__name__}.rough_env_cfg:UnitreeG1RoughEnvCfg",
    agent_cfg_entries={
...
register_task(
    task_id="RobotLab-Velocity-Flat-Unitree-G1-v0",
    env_cfg=f"{__name__}.flat_env_cfg:UnitreeG1FlatEnvCfg",
    agent_cfg_entries={
