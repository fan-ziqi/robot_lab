...
# Pre-defined configs
##
from robot_lab.assets.bdx import BDX_ACTION_SCALE, BDX_CFG  # isort: skip
...
class BdxRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.actions.joint_pos.scale = BDX_ACTION_SCALE
        ...
        if self.__class__.__name__ == "BdxRoughEnvCfg":
