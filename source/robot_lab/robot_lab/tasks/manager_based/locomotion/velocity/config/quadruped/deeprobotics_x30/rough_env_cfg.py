...
# Pre-defined configs
##
from robot_lab.assets.deeprobotics import DEEPROBOTICS_X30_CFG  # isort: skip


@configclass
class DeeproboticsX30RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Sence------------------------------
        self.scene.robot = DEEPROBOTICS_X30_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "DeeproboticsX30RoughEnvCfg":
