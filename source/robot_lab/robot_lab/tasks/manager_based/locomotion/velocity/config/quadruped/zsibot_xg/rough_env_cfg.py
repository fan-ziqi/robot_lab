...
# Pre-defined configs
##
from robot_lab.assets.zsibot import ZSIBOT_XG_CFG  # isort: skip


@configclass
class ZsibotXGRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "ZsibotXGRoughEnvCfg":
