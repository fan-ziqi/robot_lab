...
DEEPROBOTICS_X30_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=urdf_to_usd(  # type: ignore
            file_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/deeprobotics/x30_description/urdf/x30.urdf",
            output_usd_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/deeprobotics/x30_description/usd/x30.usd",
            merge_joints=True,
            fix_base=False,
        ),
