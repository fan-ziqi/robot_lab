...
It renames all the occurrences of robot_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the robot_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "robot_lab", "robot_lab"),
            os.path.join(root_dir_path, "exts", "robot_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "robot_lab"), os.path.join(root_dir_path, "exts", new_name))
