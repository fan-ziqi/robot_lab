...
It renames all the occurrences of real_robot_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the real_robot_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "real_robot_lab", "real_robot_lab"),
            os.path.join(root_dir_path, "exts", "real_robot_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "real_robot_lab"), os.path.join(root_dir_path, "exts", new_name))
