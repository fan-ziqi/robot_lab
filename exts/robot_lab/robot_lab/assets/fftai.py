...
FFTAI_GR1T1_CFG = ArticulationCfg(
    ...
    actuators={
        "actuators": ImplicitActuatorCfg(
            joint_names_expr=[".*"],
            stiffness={
                '.*_hip_roll': 251.625, '.*_hip_yaw': 362.5214, '.*_hip_pitch': 200,
                '.*_knee_pitch': 200,
                '.*_ankle_pitch': 10.9805, '.*_ankle_roll': 0.25,
                'waist_yaw': 362.5214, 'waist_pitch': 362.5214, 'waist_roll': 362.5214,
                'head_yaw': 10.0, 'head_pitch': 10.0, 'head_roll': 10.0,
                '.*_shoulder_pitch': 92.85, '.*_shoulder_roll': 92.85, '.*_shoulder_yaw': 112.06,
                '.*_elbow_pitch': 112.06,
                '.*_wrist_yaw': 10.0, '.*_wrist_roll': 10.0, '.*_wrist_pitch': 10.0
            },
            damping={
                '.*_hip_roll': 14.72, '.*_hip_yaw': 10.0833, '.*_hip_pitch': 11,
                '.*_knee_pitch': 11,
                '.*_ankle_pitch': 0.5991, '.*_ankle_roll': 0.01,
                'waist_yaw': 10.0833, 'waist_pitch': 10.0833, 'waist_roll': 10.0833,
                'head_yaw': 1.0, 'head_pitch': 1.0, 'head_roll': 1.0,
                '.*_shoulder_pitch': 2.575, '.*_shoulder_roll': 2.575, '.*_shoulder_yaw': 3.1,
                '.*_elbow_pitch': 3.1,
                '.*_wrist_yaw': 1.0, '.*_wrist_roll': 1.0, '.*_wrist_pitch': 1.0
            },
        ),
    },
)
