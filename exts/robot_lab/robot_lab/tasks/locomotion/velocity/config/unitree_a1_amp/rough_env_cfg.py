...
class UnitreeA1AmpRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.rewards.track_lin_vel_xy_exp.weight = 1.5 * 1. / (.005 * 6)
        self.rewards.track_ang_vel_z_exp.weight = 0.5 * 1. / (.005 * 6)
        ...
        self.amp_loader = AMPLoader(motion_files=self.amp_motion_files, device=self.sim.device, time_between_frames=self.sim.dt)
