...
class AnymalDRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.foot_slip.params["sensor_cfg"].body_names = ".*FOOT"
        self.rewards.foot_slip.params["asset_cfg"].body_names = ".*FOOT"
        self.rewards.joint_power.weight = -2e-5 # add
        self.rewards.stand_still_when_zero_command.weight = 0 # add
